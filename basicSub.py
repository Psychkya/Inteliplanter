...
clientId = "BaseReader"
topic = "$aws/things/InteliPlanter/shadow/name/InteliPlanShadow/update"
...
loopCount = 0
while True:
    JSONPayload = '{"state": {"reported": {"temperature":"' + str(random.randint(0,100)) + \
    '","soil":"' + str(random.randint(0,100)) + '"} }}'
